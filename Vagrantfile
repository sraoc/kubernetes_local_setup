...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 30080, host: 30081, protocol: "tcp"
  config.vm.network :private_network, ip: NODE_IP

  config.vm.synced_folder "/home/seshu/Hasuro_io/vagrant/pangaea-cache/", "/opt/pangaea/cache",
                          :nfs => true, :mount_options => ['nolock,vers=3,udp']
  config.vm.synced_folder "/home/seshu/Hasuro_io/hellonode", "/hellonode"
